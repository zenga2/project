...
(function (global, undefined) {
     ...
     */
    if (isWebWorker) {
        var requestFromWebWorker = function requestFromWebWorker(url, callback, charset, crossorigin) {
        ...
        (function () {
            var request = function request(url, callback, charset, crossorigin) {
            ...
            var addOnload = function addOnload(node, callback, url) {
